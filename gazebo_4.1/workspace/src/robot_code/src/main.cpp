...
int main(int argc, char **argv) {
    ...
    controller_params.p_gain_linear_velocity = 1.;
    controller_params.i_gain_linear_velocity = 1.;
    controller_params.d_gain_linear_velocity = 0.1;
    ...
    controller_params.desired_max_velocity = 0.25;
    controller_params.desired_max_accel = 1.;
